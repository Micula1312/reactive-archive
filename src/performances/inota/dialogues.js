...
export default {
  ...
  scene01: [
    ...
    cue(36.780, 45.042, "But the body has always known\nit was a current."),
    cue(48.856, 57.754, "A presence\ndoes not need to be readable to be real."),
    cue(61.568, 69.195, "It can appear.\nDisappear. Return in another form."),
  ...
  scene02: [
    ...
    cue(43.000, 55.000, "They convince you that the cage\nwas your own choice."),
  ...
  scene04: [
    cue(5.000, 19.000, "Perhaps freedom is not escaping the system."),
    cue(22.000, 39.000, "Perhaps it is learning to flow through it\nwithout becoming its shape."),
    cue(43.000, 56.000, "I am not here\nto guide you."),
    cue(60.000, 74.000, "I am here to remind you\nthat inside you there is still"),
  ...
  scene05: [
    ...
    cue(24.000, 33.000, "Perhaps this is why we were taught\nto fear what overflows."),
  ...
  scene06: [
    cue(1.000, 8.500, "A memory that does not capture,\nbut returns."),
    cue(10.000, 20.700, "A network that does not separate,\nbut lets things pass."),
